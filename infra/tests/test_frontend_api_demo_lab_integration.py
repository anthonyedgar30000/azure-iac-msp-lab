...
class FrontendApiDemoLabIntegrationTests(unittest.TestCase):
    def test_candidate_api_configuration_is_bounded_and_https(self) -> None:
        ...
        self.assertTrue(config["live_demo_api_url"].startswith("https://"))
        self.assertTrue(config["live_demo_api_url"].endswith("/api/demo/run"))
