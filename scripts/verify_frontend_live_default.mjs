...
const expectedApi = 'https://st-demo-api-vm-aeg30000.westus2.cloudapp.azure.com/api/demo/run';
...
requireCondition(
  sourceConfig.activation_status === 'live_default_pending_github_pages_verification',
