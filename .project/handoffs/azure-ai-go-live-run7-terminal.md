...
At reconciliation start, open work included:

- PR #225 — Lab Factory read-only preflight implementation;
- PR #227 — one interactive ServiceTracer Lab Factory preflight authorization.

Both branches were based before run-7 merge commit `90befdda...` and require their own freshness checks before merge. They do not authorize any Azure AI retry.
